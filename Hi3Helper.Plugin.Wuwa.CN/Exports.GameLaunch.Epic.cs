...
{
    private const string EpicLaunchUri =
        "com.epicgames.launcher://apps/e885327ce4414509bff4c10757f88334%3Ab873e9e6a8bb4801b700dda4cc33078c%3Aa5faf668dbaf499c8dc2917bf1c346e5?action=launch&silent=true";

    private Process[] EpicProcesses = [];
    private DateTime? EpicStartTime;
    private bool IsEpicLoading;

    private async Task<bool> TryInitializeEpicLauncher(GameManagerExtension.RunGameFromGameManagerContext context,
        CancellationToken token)
    {
        if (context.PresetConfig is not WuwaEpicPresetConfig presetConfig) return true;
    ...
    private async Task TryKillEpicLauncher(GameManagerExtension.RunGameFromGameManagerContext context,
        CancellationToken token)
    {
        try
        {

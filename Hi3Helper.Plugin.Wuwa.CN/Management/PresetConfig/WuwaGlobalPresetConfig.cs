...
public partial class WuwaGlobalPresetConfig : WuwaPresetConfig
{
    ...
    public override string GameExecutableName =>
        field ??= Path.Combine("Client", "Binaries", "Win64", EngineExecutableName);

    [field: AllowNull] [field: MaybeNull] public override string? StartExecutableName => field ??= ExecutableName;
    ...
    [field: AllowNull] [field: MaybeNull] public override string GameVendorName => field ??= VendorName;

    [field: AllowNull]
    [field: MaybeNull]
    public override string GameRegistryKeyName => field ??= Path.GetFileNameWithoutExtension(ExecutableName);

    [field: AllowNull] [field: MaybeNull] public override string ProfileName => field ??= "WuwaGlobal";
    ...
    public override string ZoneLogoUrl =>
        field ??= "https://cdn.collapselauncher.com/cl-cdn/inhouse-plugin/wuwa/wuthering-waves-logo.png";

    [field: AllowNull]
    [field: MaybeNull]
    public override string ZonePosterUrl =>
        field ??= "https://cdn.collapselauncher.com/cl-cdn/metadata/game_posters/poster_wuwa.png";
    ...
    [field: AllowNull] [field: MaybeNull] public override string GameMainLanguage => field ??= "en";
